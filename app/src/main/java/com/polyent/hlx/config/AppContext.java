...
import com.polyent.hlx.utils.StringUtils;
...
//        }
    ...
    public void saveUserInfo(final LoginUserBean user) {
        ...
        setProperties(new Properties() {
            {
                ...
                setProperty("user.face", user.getFaceurl());// 用户头像-文件名

                setProperty("user.logintoken", user.getLogin_token());
//                setProperty("user.account", user.getAccount());
//                setProperty("user.pwd",
//                        CyptoUtils.encode("oschinaApp", user.getLogin_token()));
...
//                        String.valueOf(user.isRememberMe()));// 是否记住我的信息
        ...
        setProperties(new Properties() {
            {
                ...
                setProperty("user.face", user.getFaceurl());// 用户头像-文件名
                setProperty("user.followers",
                        String.valueOf(user.getFollows()));
                setProperty("user.fans", String.valueOf(user.getFans()));
                setProperty("user.gender", String.valueOf(user.getGender()));
            }
        });
    ...
    public User getLoginUser() {
        ...
        user.setLogin_token(getProperty("user.logintoken"));
